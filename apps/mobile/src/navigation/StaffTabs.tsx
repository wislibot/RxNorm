...
function StaffRecordsNavigator() {
  ...
  return (
    <RecordsStack.Navigator
      ...
      screenOptions={{ contentStyle: { backgroundColor: colors.background }, headerShadowVisible: false }}
    >
...
function StaffSearchNavigator() {
  ...
  return (
    <SearchStack.Navigator
      initialRouteName="StaffSearchHome"
      screenOptions={{ contentStyle: { backgroundColor: colors.background }, headerShadowVisible: false }}
    >
      <SearchStack.Screen component={StaffSearchScreen} name="StaffSearchHome" options={{ headerShown: false }} />
      <SearchStack.Screen
...
export function StaffTabs() {
  ...
  return (
    <NavigationContainer>
        ...
        screenOptions={({ route }) => ({
          ...
          tabBarIcon: ({ color, focused, size }) => {
            const iconMap: Record<string, keyof typeof Ionicons.glyphMap> = {
              StaffSearch: focused ? 'search' : 'search-outline',
      ...
      >
        <Tab.Screen name="StaffSearch" component={StaffSearchNavigator} options={{ title: t('searchTab') }} />
