-- Integrate rx_merge_medication_lines into rx_match_medication_lines
--
-- Updates rx_match_medication_lines to call rx_merge_medication_lines at the
-- start of the function body, so adjacent/related medication lines are merged
-- before the matching passes run.

-- =========================================================================
-- Update rx_match_medication_lines to integrate merge step
-- =========================================================================
...
as $$
    ...
    input_lines as (
        ...
        from merged_lines, unnest(merged_lines.lines) WITH ORDINALITY AS source(input_text, ordinality)
    ),
